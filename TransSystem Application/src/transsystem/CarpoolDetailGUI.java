 ...
 * @author Sabrina
 */
public class CarpoolDetailGUI extends javax.swing.JFrame {

    /**
     * Creates new form CarpoolDetailGUI
     */
    public CarpoolDetailGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Carpool Detail Information");
        ...
        jButton1.setText("Provide Carpool");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Carpool carpool=new Carpool(LocalTime.of(Integer.parseInt(jTextField1.getText()),Integer.parseInt(jTextField2.getText())), LocalTime.of(Integer.parseInt(jTextField3.getText()),Integer.parseInt(jTextField4.getText())), (String)jComboBox1.getSelectedItem(), (String)jComboBox2.getSelectedItem(), Integer.parseInt((String)jComboBox3.getSelectedItem()), TransSystem.getPr());
        TransSystem.addCarpool(carpool);
        carpool.getProvider().addPoint();
        int pointRewards=carpool.getProvider().getPoint();
        JOptionPane.showMessageDialog(null, "Add Carpool Schedule Successfully!"+"\n"+"Your current points rewards is: "+pointRewards);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CarpoolDetailGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CarpoolDetailGUI().setVisible(true);
            }
        });
    }
